...
<form 	action = "ABAIT_scale.php" method = "post">
<?
...
?>
		...
		<h5 id="footer">
		<ul>
			<li><a href = "logout.php">ABAIT Home</a></li>
			<li><a href = "clienthomepage.php">Caregiver Home Page</a></li>
			<li><a href = "mailto:bott1@centurytel.net?subject=Feedback on Previous Session List Page">Contact ABAIT</a></li>
